      ...
      <div className='container contactContainer'>
        <div className='contactOptions'>
          <div className='contactOption'>
            ...
            <h4>Email</h4>
            <h5>shahavni154@gmail.com</h5>
            <a href = "mailto:shahavni154@gmail.com" target='_blank'>Send a message</a>
          </div>
          <div className='contactOption'>
            <WhatsAppIcon className='contactOptionIcon'/>
            <h4>WhatsApp</h4>
            <h5>+91 8130923237</h5>
            <a href = "https://api.whatsapp.com/send?phone=+918130923237" target='_blank'>Send a message</a>
          </div>
        </div>
